...
# Convert raster segments to GeoJSON polygons
polys = []
for shp, value in shapes(segments, transform=affine):
    polys.append(shp)
    
# Calculate mean zonal stats of NDVI
...
polys_gdf.to_file("/Users/aaron/Desktop/temp/mypolysFT.shp")

# Create binary raster output of water features
out_fn = '/Users/aaron/Desktop/temp/rasterizedFT.tif'
